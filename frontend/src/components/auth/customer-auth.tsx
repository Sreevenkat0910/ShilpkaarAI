          ...
          <CardContent className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-3 py-4 border-t border-primary/10">
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground">Shop Crafts</p>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 mx-auto mb-2 bg-red-100 rounded-lg flex items-center justify-center">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground">Meet Artisans</p>
              </div>
            </div>
