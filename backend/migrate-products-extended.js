...
const productsData = [
  ...
  {
    name: 'Cotton Handloom Shirt',
    description: 'Comfortable cotton handloom shirt perfect for casual wear.',
    price: 800,
    original_price: 1000,
    images: ['https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?w=400'],
    category: 'Textiles',
    ...
    craft: 'Handloom Weaving',
    stock: 10,
    tags: ['cotton', 'handloom', 'shirt', 'casual'],
    materials: ['Cotton'],
    color: ['White', 'Blue'],
    size: 'L',
    condition: 'new',
    ...
    featured: false,
    trending: false,
    search_keywords: ['shirt', 'cotton', 'handloom', 'casual', 'comfortable'],
    artisan_name: 'Kavita Singh',
    rating: 4.6,
    review_count: 123
  },
  {
    name: 'Silk Scarf with Zari Border',
    description: 'Elegant silk scarf with intricate zari border work.',
    price: 650,
    original_price: 800,
    images: ['https://images.unsplash.com/photo-1583394838336-acd977736f90?w=400'],
    category: 'Textiles',
    ...
    featured: false,
    trending: true,
    search_keywords: ['scarf', 'silk', 'zari', 'elegant', 'border'],
    artisan_name: 'Priya Sharma',
    rating: 4.7,
    review_count: 167
  },

  // POTTERY CATEGORY - 8 products
  {
  ...
  },
  {
    ...
    description: 'Traditional blue pottery tea set with matching cups and saucers.',
    price: 1400,
    original_price: 1700,
    images: ['https://images.unsplash.com/photo-1716876995651-1ff85b65a6d9?w=400'],
    category: 'Pottery',
    ...
    craft: 'Blue Pottery',
    stock: 7,
    tags: ['blue pottery', 'tea set', 'traditional', 'cups'],
    materials: ['Clay', 'Blue Glaze'],
    color: ['Blue', 'White'],
    size: 'Medium',
    condition: 'new',
    ...
    featured: false,
    trending: true,
    search_keywords: ['blue pottery', 'tea set', 'traditional', 'cups', 'saucers'],
    artisan_name: 'Rajesh Kumar',
    rating: 4.6,
    review_count: 178
  },

  // JEWELRY CATEGORY - 10 products
  {
  ...
  },
  {
    ...
    description: 'Traditional silver bangles set with intricate designs.',
    price: 1200,
    original_price: 1500,
    images: ['https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=400'],
    category: 'Jewelry',
    ...
    craft: 'Silver Work',
    stock: 8,
    tags: ['silver', 'bangles', 'traditional', 'set'],
    materials: ['Silver'],
    color: ['Silver'],
    size: 'One Size',
    condition: 'new',
    ...
    featured: false,
    trending: true,
    search_keywords: ['silver', 'bangles', 'traditional', 'set', 'jewelry'],
    artisan_name: 'Anita Verma',
    rating: 4.7,
    review_count: 156
  },

  // WOODWORK CATEGORY - 8 products
  {
...
async function migrateProducts(artisans) {
  try {
